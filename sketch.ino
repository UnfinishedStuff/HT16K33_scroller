...
//Const int for holding th emaximum number of letters permitted for display
const int maxChars = 500;

//Const int for holding the delay in ms between each frame moving
const int pause = 100;

/* Declare a large array for holding the data to be displayed (maxChars + 32 for
blank screes at both the start and beginning of the data */
byte data[532];
...
const byte letters[95][6] = {
  ...
  {0b00000000, 0b00000000, 0b11111101, 0b00000000, 0b00000000, 0b00000000}, //!
  ...
  {0b00000001, 0b00000110, 0b00011000, 0b01100000, 0b10000000, 0b00000000}, // /
  ...
  {0b01110000, 0b10001000, 0b10001000, 0b10001000, 0b11111111, 0b00000000}, //9
  ...
  {0b00000000, 0b10000001, 0b01000010, 0b00100100, 0b00011000, 0b00000000}, //>
  ...
  {0b01111111, 0b10001000, 0b10001000, 0b10001000, 0b01111111, 0b00000000}, //A
  {0b11111111, 0b10001001, 0b10001001, 0b10001001, 0b01110110, 0b00000000}, //B
  {0b01111110, 0b10000001, 0b10000001, 0b10000001, 0b10000001, 0b00000000}, //C
  {0b11111111, 0b10000001, 0b10000001, 0b10000001, 0b01111110, 0b00000000}, //D
  
  {0b11111111, 0b10001001, 0b10001001, 0b10000001, 0b10000001, 0b00000000}, //E
  {0b11111111, 0b10001000, 0b10001000, 0b10001000, 0b10000000, 0b00000000}, //F
  {0b01111110, 0b10000001, 0b10001001, 0b10001001, 0b00000110, 0b00000000}, //G
  {0b11111111, 0b00001000, 0b00001000, 0b00001000, 0b11111111, 0b00000000}, //H
  
  {0b10000001, 0b10000001, 0b11111111, 0b10000001, 0b10000001, 0b00000000}, //I
  {0b10000001, 0b10000001, 0b11111110, 0b10000000, 0b10000000, 0b00000000}, //J
  {0b11111111, 0b00011000, 0b00100100, 0b01000010, 0b10000001, 0b00000000}, //K
  {0b11111111, 0b00000001, 0b00000001, 0b00000001, 0b00000001, 0b00000000}, //L

  {0b11111111, 0b01000000, 0b00110000, 0b01000000, 0b11111111, 0b00000000}, //M
  {0b11111111, 0b01000000, 0b00110000, 0b00001000, 0b11111111, 0b00000000}, //N
  {0b01111110, 0b10000001, 0b10000001, 0b10000001, 0b01111110, 0b00000000}, //O
  {0b11111111, 0b10001000, 0b10001000, 0b10001000, 0b01110000, 0b00000000}, //P

  {0b01111110, 0b10000001, 0b10000101, 0b10000010, 0b01111101, 0b00000000}, //Q
  {0b11111111, 0b10001000, 0b10001100, 0b10001010, 0b01110001, 0b00000000}, //R
  {0b01110010, 0b10001001, 0b10001001, 0b10001001, 0b01000110, 0b00000000}, //S
  {0b10000000, 0b10000000, 0b11111111, 0b10000000, 0b10000000, 0b00000000}, //T

  {0b11111110, 0b00000001, 0b00000001, 0b00000001, 0b11111110, 0b00000000}, //U
  {0b11111000, 0b00000110, 0b00000001, 0b00000110, 0b11111000, 0b00000000}, //V
  {0b11111111, 0b00000010, 0b00001100, 0b00000010, 0b11111111, 0b00000000}, //W
  {0b11000011, 0b00100100, 0b00011000, 0b00100100, 0b11000011, 0b00000000}, //X

  {0b11100000, 0b00010000, 0b00001111, 0b00010000, 0b11100000, 0b00000000}, //Y
  {0b10000011, 0b10000101, 0b10011001, 0b10100001, 0b11000001, 0b00000000}, //Z
...
void loop()
{
  ...
  if (Serial.available())
  {
    ...
    while (Serial.available() and (numLetters < maxChars))
      {
...
/* Pass a register address, array and the size of the array to block-write the 
bytes to the device */
